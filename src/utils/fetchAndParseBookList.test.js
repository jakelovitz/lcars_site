...
describe('fetchAndParseBookList', () => {
    ...
    test('successfully fetches and parses book list', async () => {
        const mockCSV = 'Title,Subtitle,Author(s),Author(s) - Last Name,Genre,Sub-Genre,ISBN,OLID,Series,Volume,Exclude\n' +
        ...
        const mockBooks = [
            { title: 'Book 1', subtitle: 'Subtitle 1', authors: 'Author A', sorted_authors: 'Author A', genre: 'Genre A', subGenre: 'Sub-Genre A', isbn: '1234567890', olid: 'OL12345M', series: 'Series A', volume: 1 },
            { title: 'Book 2', subtitle: '', authors: 'Author B', sorted_authors: 'Author B', genre: 'Genre B', subGenre: 'Not Specified', isbn: '0987654321', olid: 'OL67890M', series: '', volume: 2 }
        ];
        ...
        Papa.parse.mockImplementation((csvText, options) => {
            options.complete({ data: [
                { "Title": "Book 1", "Subtitle": "Subtitle 1", "Author(s)": "Author A", "Author(s) - Last Name": "Author A", "Genre": "Genre A", "Sub-Genre": "Sub-Genre A", "ISBN": "1234567890", "OLID": "OL12345M", "Series": "Series A", "Volume": "1", "Exclude": "" },
                { "Title": "Book 2", "Subtitle": "", "Author(s)": "Author B", "Author(s) - Last Name": "Author B", "Genre": "Genre B", "Sub-Genre": "", "ISBN": "0987654321", "OLID": "OL67890M", "Series": "", "Volume": "2", "Exclude": "" }
            ] });
        });
        ...
        expect(fetch).toHaveBeenCalledWith(expect.stringContaining('https://docs.google.com/spreadsheets'));
